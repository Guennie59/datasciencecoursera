...
Calculting a posix date/time and weekday from it. Also determining the weekday vs weekendday and adding as extra
...
The following code reads data plots a histogram of the sum of steps per day.
